...
#Importo i file
dat = n.genfromtxt('30/Dati30g1.txt')
dat1 = n.genfromtxt('30/Dati30g2.txt')
dat2 = n.genfromtxt('30/Dati30g3.txt')
dat3 = n.genfromtxt('30/Dati30g4.txt')
dat4 = n.genfromtxt('30/Dati30g5.txt')
...
x = x[:153] #153 è il più breve tra QUESTI file, va cambiato per ogni angolo
y = y[:153]
x1 = x1[:153]
y1 = y1[:153]
x2 = x2[:153]
...
sigmaalpha = 0.00145
g = B/(n.sin(0.008727))
sigmag = n.sqrt((g**2)*((sigmab**2/B**2)+(sigmaalpha**2/n.tan(0.00872)**2)))

print(sigmag)
print('g =',2*p[0]/(n.sin(0.008727))) #Calcolo Effettivo accelerazione di gravità
"""
g = 8.66283299578
errore di g:  1.619863868
errore relativo: 18.7%
"""
